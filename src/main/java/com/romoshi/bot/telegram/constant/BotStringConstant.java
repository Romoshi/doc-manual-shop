...
public class BotStringConstant {
    ...
    public static final String NOT_FILE = "Это не то что я жду. Попробуйте заново. Мне нужен файл с расшрением pdf :)";
    public static final String FILE_CANT_FOUND = "Файл отсутствует.";
